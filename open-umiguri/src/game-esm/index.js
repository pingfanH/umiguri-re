...
if (addEventListener("resize", scope.v_m1_27881), addEventListener("unload", scope.v_re_27878), addEventListener("focus", scope.v_w1_27879), addEventListener("blur", scope.v_g1_27880), addEventListener("beforeunload", v_t_35119 => {
  ...
  scope.v_ie_27875(), scope.v_Oa_28077(function (v_t_35153, v_i_35154) {
    ...
    !function () {
      ...
      return scope.glContext.enable(scope.glContext.BLEND), scope.glContext.blendFunc(scope.glContext.SRC_ALPHA, scope.glContext.ONE_MINUS_SRC_ALPHA), scope.glContext.canvas.width = scope.v_yn_27656 * (window.__umgPixelScale || 1), scope.glContext.canvas.height = scope.v_Sn_27657 * (window.__umgPixelScale || 1), scope.v_y_27559.appendChild(scope.glContext.canvas), scope.glContext.viewport(0, 0, scope.v_yn_27656 * (window.__umgPixelScale || 1), scope.v_Sn_27657 * (window.__umgPixelScale || 1)), scope.glContext.matrixMode(scope.glContext.MODELVIEW), scope.glContext.canvas.addEventListener("webglcontextlost", scope.v_te_27874), scope.v_y_27559.style.width = scope.v_yn_27656 + "px", scope.v_y_27559.style.height = scope.v_Sn_27657 + "px", scope.v_ee_27876(), 1;
