...
scope.v_H_27654 = "";
scope.v_zt_27655 = !0;
scope.v_yn_27656 = 1920;
scope.v_Sn_27657 = 1080;
...
scope.v_Z1_27919 = window.w = scope.audioFontHub, function () {
  ...
  async function v_l_29292() {
    for (v_s_29289.rsbTree.elementByIndex(15).visible = !0, v_s_29289.rsbTree.elementByIndex(30).visible = !1, scope.menuSystem.wt("payment", !1), scope.menuSystem.wt("balance", !0), scope.menuSystem.kt("balance", !0), scope.menuSystem.kt("payment", !0), await v_o_29291(), scope.menuSystem.kt("balance", !1), scope.menuSystem.kt("payment", !1), scope.v_D_27646.eS(100), ++v_a_29290.QA; !v_a_29290.tS;) {
  ...
  function v_c_29293(v_t_29296) {
    switch (v_t_29296) {
      ...
      case "balance":
        !async function () {
          for (v_s_29289.rsbTree.elementByIndex(15).visible = !1, v_s_29289.rsbTree.elementByIndex(30).visible = !0, scope.menuSystem.wt("payment", !0), scope.menuSystem.wt("balance", !1), scope.menuSystem.kt("balance", !0), scope.menuSystem.kt("payment", !0), await v_o_29291(), scope.menuSystem.kt("balance", !1), scope.menuSystem.kt("payment", !1), scope.v_D_27646.lS(), ++v_a_29290.QA; !v_a_29290.tS;) {
            var v_t_29297,
  ...
  return {
    ...
    qA: async function (v_t_29304) {
      ...
      for (v_s_29289.rsbTree.elementByIndex(11).Wt = (v_e_29306 * v_t_29304).toString(), v_s_29289.rsbTree.elementByIndex(14).Wt = v_t_29304.toString(); !v_a_29290.$A;) {
        ...
        v_s_29289.rsbTree.elementByIndex(9).Wt = (scope.v_R1_27896.YA() + scope.mathMin(scope.v_R1_27896.ZA(), v_t_29304) * v_e_29306).toString(), await scope.renderer.C7(250);
      }
      return v_i_29305 && (v_s_29289.rsbTree.elementByIndex(9).Wt = (v_e_29306 * v_t_29304).toString()), scope.menuSystem.Ct(!0), scope.menuSystem.It(!1), await v_o_29291(), v_s_29289.e8(1), await scope.renderer.C7(scope.v_Ge_28204(30)), scope.renderer._i("paymentModal"), scope.menuSystem.Ct(!1), scope.menuSystem._t(), v_a_29290.Gi = !1, scope.sceneManager._t(), v_i_29305;
    },
    C9: v_u_29294,
    Gi: () => v_a_29290.Gi
  };
...
scope.v_dr_27936.prototype = {
  ...
  lw: function () {
    ...
    for (let v_t_32030 = 0; v_t_32030 < v_r_32029.length; ++v_t_32030) if (v_i_32026 = (v_e_32027 = v_r_32029[v_t_32030]).Fi & scope.v_xn_27661, v_e_32027.Fi === scope.v_ce_27678 || v_e_32027.Fi === scope.v_le_27675 || v_e_32027.Fi === scope.v_ue_27682 || v_e_32027.Fi === scope.v_t0_27693 || v_e_32027.Fi === scope.v_s0_27698) {
      v_e_32027.ou = 16 - v_e_32027.w - v_e_32027.ou;
      for (let v_t_32031 = 0; v_t_32031 < v_e_32027.We.length; ++v_t_32031) (v_n_32028 = v_e_32027.We[v_t_32031]).ou = 16 - v_n_32028.w - v_n_32028.ou;
    } else v_i_32026 !== scope.v_Cn_27662 && v_i_32026 !== scope.v_zn_27686 || (v_e_32027.ou = 16 - v_e_32027.w - v_e_32027.ou, v_e_32027.Fi === scope.v_qn_27689 ? v_e_32027.Fi = scope.v_Zn_27690 : v_e_32027.Fi === scope.v_Zn_27690 ? v_e_32027.Fi = scope.v_qn_27689 : v_e_32027.Fi === scope.v_Qn_27692 ? v_e_32027.Fi = scope.v_$n_27691 : v_e_32027.Fi === scope.v_$n_27691 ? v_e_32027.Fi = scope.v_Qn_27692 : v_e_32027.Fi === scope.v_En_27669 ? v_e_32027.Fi = scope.v_Dn_27670 : v_e_32027.Fi === scope.v_Dn_27670 ? v_e_32027.Fi = scope.v_En_27669 : v_e_32027.Fi === scope.v_Fn_27671 ? v_e_32027.Fi = scope.v_Bn_27672 : v_e_32027.Fi === scope.v_Bn_27672 && (v_e_32027.Fi = scope.v_Fn_27671));
  },
  cw: function (v_t_32032) {
    ...
    for (let v_i_32049 = 0; v_i_32049 < v_e_32033.length; ++v_i_32049) if ((v_n_32034 = v_e_32033[v_i_32049]).Fi === scope.v_Tn_27663 || v_n_32034.Fi === scope.v_ce_27678 || v_n_32034.Fi === scope.v_le_27675 || v_n_32034.Fi === scope.v_Pn_27665 || scope.v__0_27710(v_n_32034.Fi)) {
      for (let v_t_32050 = v_e_32033.length - 1; v_t_32050 > v_i_32049; --v_t_32050) if ((v_r_32035 = v_e_32033[v_t_32050]).Fi === scope.v_Tn_27663 || v_r_32035.Fi === scope.v_ce_27678 || v_r_32035.Fi === scope.v_le_27675 || v_r_32035.Fi === scope.v_Pn_27665 || scope.v__0_27710(v_r_32035.Fi)) {
        if (v_n_32034.od >= v_r_32035.od) break;
        if (v_r_32035.ou + v_r_32035.w > v_n_32034.ou && v_r_32035.ou < v_n_32034.ou + v_n_32034.w) if (v_a_32037 = v_n_32034.od, v_o_32038 = v_r_32035.od, v_s_32036 = v_o_32038 - v_a_32037, v_u_32041 = scope.mathMax(v_r_32035.ou, v_n_32034.ou), v_f_32042 = scope.mathMin(v_r_32035.ou + v_r_32035.w, v_n_32034.ou + v_n_32034.w), scope.v__0_27710(v_n_32034.Fi) || (v_n_32034.Fi === scope.v_ce_27678 || v_n_32034.Fi === scope.v_le_27675) && 1 === v_n_32034.Jg) for (let v_t_32051 = 0; v_t_32051 < 16; ++v_t_32051) v_t_32051 >= v_u_32041 && v_t_32051 < v_f_32042 ? v_n_32034.Hg[v_t_32051] = scope.mathMax(v_n_32034.Hg[v_t_32051], -v_s_32036 + v_r_32035.jg[v_t_32051]) : v_n_32034.Hg[v_t_32051] = scope.mathMax(v_n_32034.Hg[v_t_32051], -v_c_32040);else {
      ...
      for (let v_t_32053 = v_n_32034.ou; v_t_32053 < v_n_32034.ou + v_n_32034.w; ++v_t_32053) v_n_32034.yw = scope.mathMin(v_n_32034.yw, scope.mathMax(v_n_32034.Hg[v_t_32053], -v_c_32040));
    }
    for (let v_i_32054 = 0; v_i_32054 < v_e_32033.length; ++v_i_32054) if ((v_n_32034 = v_e_32033[v_i_32054]).Fi === scope.v_Tn_27663 || v_n_32034.Fi === scope.v_ce_27678 || v_n_32034.Fi === scope.v_le_27675 || v_n_32034.Fi === scope.v_Pn_27665 || scope.v__0_27710(v_n_32034.Fi)) for (let v_t_32055 = v_i_32054 + 1; v_t_32055 < v_e_32033.length; ++v_t_32055) if (((v_r_32035 = v_e_32033[v_t_32055]).Fi === scope.v_Tn_27663 || v_r_32035.Fi === scope.v_ce_27678 || v_r_32035.Fi === scope.v_le_27675 || v_r_32035.Fi === scope.v_Pn_27665 || scope.v__0_27710(v_r_32035.Fi)) && !(v_n_32034.od >= v_r_32035.od) && v_r_32035.ou + v_r_32035.w > v_n_32034.ou && v_r_32035.ou < v_n_32034.ou + v_n_32034.w) if (v_a_32037 = v_n_32034.od, v_o_32038 = v_r_32035.od, v_s_32036 = v_o_32038 - v_a_32037, v_u_32041 = scope.mathMax(v_r_32035.ou, v_n_32034.ou), v_f_32042 = scope.mathMin(v_r_32035.ou + v_r_32035.w, v_n_32034.ou + v_n_32034.w), scope.v__0_27710(v_r_32035.Fi) || (v_r_32035.Fi === scope.v_ce_27678 || v_r_32035.Fi === scope.v_le_27675) && 1 === v_r_32035.Jg) for (let v_t_32056 = 0; v_t_32056 < 16; ++v_t_32056) v_t_32056 >= v_u_32041 && v_t_32056 < v_f_32042 && (v_r_32035.jg[v_t_32056] = scope.mathMin(v_s_32036 + v_n_32034.Hg[v_t_32056]));else {
      let v_i_32057 = 1 / 0;
        ...
        default:
          if (!isNaN(scope.v_Pe_28064(v_a_32142[0].substr(0, 3)))) {
            ...
            if (v_n_32149 !== scope.v_Hn_27677 && v_n_32149 !== scope.v_Gn_27674 && 64 != v_n_32149 || (v_r_32150 = parseInt(v_a_32142[0].substr(5, 1), 36)), 2 == (v_n_32149 | v_e_32148)) {
              ...
              for (let v_t_32151 = 0; v_t_32151 < v_c_32146; ++v_t_32151) "00" !== (v_l_32145 = v_a_32142[1].substr(2 * v_t_32151, 2)) && ((v_o_32144 = new scope.v_wr_27938()).mp = v_i_32147, v_o_32144.kp = v_t_32151, v_o_32144.bp = v_c_32146, 8 == (v_n_32149 | v_e_32148) ? (v_o_32144.Fi = 1, v_o_32144.Jg = parseInt(v_l_32145, 36)) : (v_o_32144.Fi = v_n_32149 | parseInt(v_l_32145[0], 36), v_o_32144.ou = v_e_32148, v_o_32144.w = parseInt(v_l_32145[1], 36), v_o_32144.xp = v_r_32150), v_o_32144.Lw = v_s_32141.$w.hp, v_o_32144.Fi !== scope.v_Jn_27679 && v_o_32144.Fi !== scope.v_Un_27676 && v_o_32144.Fi !== scope.v_Vn_27683 || (v_o_32144.Sp = 10), (v_o_32144.Fi & scope.v_xn_27661) === scope.v_zn_27686 ? (v_o_32144.Sp = 5, v_o_32144.h = 8) : 64 == (v_o_32144.Fi & scope.v_xn_27661) && (v_o_32144.h = 8), v_s_32141.$w.fp.push(v_o_32144));
            }
      ...
      scope.v_De_28096(v_c_32115.$w.fp, function (v_t_32178, v_i_32179) {
        switch (v_t_32178.Fi) {
          ...
          case scope.v_Un_27676:
            var v_e_32180;
            "number" == typeof v_r_32176[v_t_32178.xp] && v_c_32115.$w.fp[v_r_32176[v_t_32178.xp]].We.push(v_t_32178), v_t_32178.Fi === scope.v_Un_27676 && (v_e_32180 = v_c_32115.$w.fp[v_r_32176[v_t_32178.xp]], v_t_32178.ou = v_e_32180.ou, v_t_32178.w = v_e_32180.w, v_r_32176[v_t_32178.xp] = null);
            break;
    ...
    }
    {
      ...
      scope.v_De_28096(v_u_32116.$w.fp, function (v_i_32184) {
        (v_i_32184.Fi & scope.v_xn_27661) === scope.v_zn_27686 && v_i_32184.dw === scope.v_An_27660 && scope.v_De_28096(v_u_32116.$w.fp, function (v_t_32185) {
          return !(v_i_32184.Xg !== v_t_32185.Xg || v_i_32184.ou !== v_t_32185.ou || v_i_32184.w !== v_t_32185.w || (v_t_32185.Fi & scope.v_xn_27661) !== scope.v_Cn_27662 && v_t_32185.Fi !== scope.v_Jn_27679 && v_t_32185.Fi !== scope.v_Un_27676 || v_t_32185.Vg) && (v_t_32185.Vg = !0, v_i_32184.dw = v_t_32185.Fi, v_i_32184.Lw = v_t_32185.Lw, 1);
        });
        ...
        (v_i_32186.Fi & scope.v_xn_27661) !== scope.v_zn_27686 || v_i_32186.gw || scope.v_De_28096(v_u_32116.$w.fp, function (v_t_32187) {
          return v_i_32186.Xg === v_t_32187.Xg && v_i_32186.ou === v_t_32187.ou && v_i_32186.w === v_t_32187.w && v_t_32187.Fi === scope.v_ue_27682 && !v_t_32187.Vg && (v_t_32187.Vg = !0, v_i_32186.gw = !0, v_i_32186.Fi = scope.v_Kn_27687, v_t_32187.Lw = v_i_32186.Lw, 1);
        });
      });
      ...
      scope.v_De_28096(v_u_32116.$w.fp, function (v_i_32188) {
        if (((v_t_32182 = v_i_32188.Fi & scope.v_xn_27661) === scope.v_zn_27686 || v_t_32182 === scope.v_ue_27682 || v_i_32188.Fi === scope.v_Pn_27665 || v_i_32188.Vg || v_i_32188.gw) && -1 === v_e_32181.indexOf(v_i_32188.w)) {
          v_n_32183 = v_i_32188.w;
          for (let v_t_32189 = 0; v_t_32189 < v_e_32181.length; ++v_t_32189) if (v_e_32181[v_t_32189] > v_n_32183) {
            v_i_32188.w = v_e_32181[scope.mathMax(v_t_32189 - 1, 0)];
            break;
          }
        }
      }), scope.v_De_28096(v_u_32116.$w.fp, function (v_i_32190) {
        if (v_i_32190.Fi !== scope.v_ue_27682 && v_i_32190.Fi !== scope.v_t0_27693 || v_i_32190.Vg || (v_i_32190.Fi = scope.v_An_27660), 16 < v_i_32190.ou + v_i_32190.w) v_u_32116.$w.kP = !1;else for (let v_t_32191 = 0; v_t_32191 < v_i_32190.We.length; ++v_t_32191) if (16 < v_i_32190.We[v_t_32191].ou + v_i_32190.We[v_t_32191].w) return void (v_u_32116.$w.kP = !1);
      }), scope.v_De_28096(v_u_32116.$w.fp, function (v_e_32192) {
        if (scope.v__0_27710(v_e_32192.Fi)) {
          let v_i_32193 = scope.v_cc_28210(v_e_32192.ou, v_e_32192.w);
        ...
        scope.v__0_27710(v_e_32195.Fi) && scope.v_De_28096(v_u_32116.$w.fp, function (v_t_32196) {
          var v_i_32197 = scope.v_cc_28210(v_t_32196.ou, v_t_32196.w);
    ...
    v_a_32109.$w.kP || (v_a_32109.$w.fp = []);
    {
      ...
      scope.v_ao_28097(v_w_32117.$w._p, function (v_t_32207) {
        ...
        113 !== v_i_32212.Fi && 114 !== v_i_32212.Fi || scope.v_De_28096(v_w_32117.$w.fp, function (v_t_32213) {
          return v_i_32212.Xg === v_t_32213.Xg && v_i_32212.ou === v_t_32213.ou && v_i_32212.w === v_t_32213.w && v_t_32213.Fi === scope.v_Pn_27665 && 0 === v_t_32213.Jg && (v_t_32213.Jg = 113 === v_i_32212.Fi ? 1 : 2, 1);
        });
      });
      let v_e_32199,
        v_i_32200 = (scope.v_De_28096(v_w_32117.$w.fp, function (v_i_32214) {
          if (((v_e_32199 = v_i_32214.Fi & scope.v_xn_27661) === scope.v_Cn_27662 || v_e_32199 === scope.v_zn_27686 || v_i_32214.Fi === scope.v_ce_27678 || v_i_32214.Fi === scope.v_le_27675 || v_i_32214.Fi === scope.v_ue_27682 || 161 === v_i_32214.Fi || 3 === v_i_32214.Fi || v_i_32214.Fi === scope.v_u0_27704) && (v_i_32214.Fi !== scope.v_ce_27678 && v_i_32214.Fi !== scope.v_le_27675 && v_i_32214.Fi !== scope.v_ue_27682 || 0 !== v_i_32214.We.length)) {
            if ((v_v_32198 = new scope.v_fr_27933()).Vw(v_i_32214), v_v_32198.od = v_w_32117.ep(v_i_32214.Xg), v_v_32198.Kg = v_w_32117.Tw(v_v_32198.od, v_w_32117.Zu.Wg, 1), scope.v_De_28096(v_v_32198.We, function (v_t_32215) {
                ...
                if (52 !== v_t_32218.Fi) {
                  if (2 <= v_d_32217.length) {
                    let v_i_32224 = [],
                      ...
                      v_r_32227 = v_d_32217[0].w,
                      v_s_32228 = v_t_32218.w,
                      v_a_32229 = v_t_32218.Xg - v_n_32226,
                      v_o_32230;
                    scope.v_De_28096(v_d_32217, function (v_t_32231) {
                      v_o_32230 = (v_t_32231.Xg - v_n_32226) / v_a_32229, v_i_32224.push([v_t_32231.ou + v_t_32231.w / 2 - scope.v_Ee_28084(v_r_32227, v_s_32228, v_o_32230) / 2, v_o_32230]), v_e_32225.push([v_t_32231.ou + v_t_32231.w / 2 + scope.v_Ee_28084(v_r_32227, v_s_32228, v_o_32230) / 2, v_o_32230]);
                    }), v_i_32224.push([v_t_32218.ou, 1]), v_e_32225.push([v_t_32218.ou + v_t_32218.w, 1]);
                    var v_l_32219,
                      v_c_32220,
                      v_u_32221,
                      v_f_32222 = scope.v_Ja_28074(v_i_32224),
                      v___32223 = scope.v_Ja_28074(v_e_32225);
                    for (let v_t_32232 = 30; v_t_32232 < v_a_32229; v_t_32232 += 30) v_l_32219 = v_f_32222.at(v_t_32232 / v_a_32229), v_c_32220 = v___32223.at(v_t_32232 / v_a_32229), (v_u_32221 = new scope.v_fr_27933()).Fi = scope.v_On_27681, v_u_32221.ou = scope.mathMin(scope.mathMax(v_l_32219[0], 0), 16), v_u_32221.w = scope.mathMin(scope.mathMax(v_c_32220[0] - v_u_32221.ou, 1), 16 - v_u_32221.ou), v_u_32221.Lw = v_h_32216.Lw, v_u_32221.Xg = scope.mathFloor(v_n_32226 + v_a_32229 * v_l_32219[1]), v_u_32221.od = v_w_32117.ep(v_u_32221.Xg), v_u_32221.Kg = v_w_32117.Tw(v_u_32221.od, v_u_32221.Lw, 1), v_v_32198.We.push(v_u_32221);
                  }
                  v_d_32217 = [];
                }
              ...
              v_t_32236.ou = v_i_32214.ou, v_t_32236.w = v_i_32214.w;
            });
...
scope.v_Bs_28013.prototype = {
  ...
  Ly: async function () {
    ...
    scope.handshake.On.Wp = v_i_33782.targetVersion, scope.handshake.On.zp = !1, scope.handshake.On.Kp = v_i_33782.termsAgreed, scope.handshake.rm.om = v_i_33782.playerName, scope.handshake.rm.um = v_i_33782.playerLevel, scope.handshake.rm.lm = v_i_33782.playerRating, scope.handshake.On.im = v_i_33782.charaId, scope.handshake.On.nI = v_i_33782.charaTransIdx, scope.handshake.On.qp = v_i_33782.nameplateId, scope.handshake.On.$p = v_i_33782.titleId, scope.handshake.On.Qp = v_i_33782.voiceId, scope.handshake.On.tm = v_i_33782.voiceLong, scope.handshake.On.q.ee = v_i_33782.lastMusicId, scope.handshake.On.q.te = v_i_33782.lastMusicDiff, scope.handshake.On.q.ie = v_i_33782.lastActivePlayLevel, scope.handshake.On.q.ne = v_i_33782.lastActiveLevelSelect, scope.handshake.On.q.HP = v_i_33782.lastActiveUltimaSelect, scope.handshake.On.q.pL = v_i_33782.musicListSort;
    for (let v_t_33783 = 0; v_t_33783 < 20; ++v_t_33783) scope.handshake.On.iI[v_t_33783] = v_i_33782.chatIds[v_t_33783];
    return !0;
  },
  Ey: async function () {
    return scope.handshake.On.Wp = 1101, scope.handshake.On.zp = !0, scope.handshake.On.Kp = !1, scope.handshake.rm.om = "ＵＭＩＧＵＲＩ", scope.handshake.rm.um = 1, scope.handshake.rm.lm = 0, scope.handshake.On.im = "UMIGURI/uni", scope.handshake.On.nI = 0, scope.handshake.On.qp = "_0000000_sys_default", scope.handshake.On.$p = "s_00000000", scope.handshake.On.Qp = "_0000000_sys_silence", scope.handshake.On.tm = !1, scope.handshake.On.q.ee = "", scope.handshake.On.q.te = 0, scope.handshake.On.q.ie = 0, scope.handshake.On.q.ne = !1, scope.handshake.On.q.HP = !1, scope.handshake.On.q.pL = 0, scope.handshake.On.iI = scope.v_Ji_27856.concat(), !0;
  },
  TA: async function () {
    var v_t_33784 = {
...
scope.v_Po_28121.prototype = {
  ...
  Mt: function () {
    this.K8.clearRect(0, 0, this.w, this.h), this.Q8 = new scope.v_Ua_28072(this.w, this.h), this.X8 = new Map(), this.Mk = !0, this.Rk[0] = 0, this.Rk[1] = 0, this.Rk[2] = this.w, this.Rk[3] = this.h, this.Ek(this.Y8, !0);
  },
  Bk: function () {
    return this.Mk;
  },
  ...
  Hk: function (v_i_34576) {
    ...
    return v_e_34578 || ((v_t_34577 = new scope.v_Mo_28124()).Mf.push(this.Yf), v_t_34577.g_ = v_i_34576, v_t_34577.w_ = v_i_34576, v_t_34577.p_ = 0, v_t_34577.k_ = this.Pk.w, v_t_34577.b_ = this.Pk.h, v_t_34577.h_ = {
...
scope.v_xt_28153.T_ = function (v_t_34619) {
  ...
  elementByName: function (v_i_34662) {
    var v_e_34663,
      v_n_34664 = this.We;
    for (let v_t_34665 = 0; v_t_34665 < v_n_34664.length; ++v_t_34665) {
      if (v_n_34664[v_t_34665].ct === v_i_34662) return v_n_34664[v_t_34665];
      if (0 < v_n_34664[v_t_34665].We.length && (v_e_34663 = v_n_34664[v_t_34665].elementByName(v_i_34662))) return v_e_34663;
    }
    return null;
  },
  elementByIndex: function (v_t_34666) {
    var v_i_34667;
    ...
    for (var v_i_34728; !v___34723.C3();) if (1381324884 === (v_i_34728 = v___34723.v3())) {
      ...
      for (; 0 < v_t_34786.length;) {
        ...
        if (255 === v_l_34732) v_t_34786.pop();else {
          let v_i_34788;
          (v_i_34788 = new (1380732739 === v_l_34732 ? scope.v_Pl_28176 : 1381324884 === v_l_34732 ? scope.v_Ll_28178 : 1415071060 === v_l_34732 ? scope.v_Rl_28177 : 1481920595 === v_l_34732 ? scope.v_Ml_28179 : 1381256262 === v_l_34732 ? scope.v_El_28180 : scope.v_Il_28175)()).Lk = new WeakRef(v_h_34724.rsbTree), v_h_34724.rsbTree.Ck.set(v_e_34787, v_i_34788), ++v_e_34787;
          ...
          "templates" === v_i_34788.ct && 1 === v_t_34786.length && (v_i_34788.visible = !1), v_t_34786[v_t_34786.length - 1].We.push(v_i_34788), 1 & v_l_34732 && v_t_34786.push(v_i_34788);
        }
      }
    } else {
  ...
  NA: function (v_t_34831, v_i_34832, v_e_34833, v_n_34834) {
    ...
    return v_e_34833.GA = v_t_34831, v_e_34833.UA = scope.v_Ge_28204(v_s_34836), this.HA.push(v_e_34833), this.jA || (this.jA = new scope.v_Il_28175(), this.rsbTree.Ze(this.jA)), this.jA.Ze(v_t_34831), this.e8(v_i_34832, v_t_34831, 0), v_e_34833;
  },
    ...
    if (v_L_34845.Jt) {
      ...
      var v_c_34849,
        ...
        v_M_34851 = new function () {
          this.ph = 0, this.w = 0, this.h = 0, this.bh = !1, this.Sh = !1, this.xh = new scope.v_bl_28168(), this.A_ = void 0;
        }(),
      ...
      let v_g_34898 = new scope.v_xt_28153(),
        ...
        v_r_34903,
        v_y_34904 = ((v_r_34903 = new v_wt_34912()).Ih = this.rsbTree, v_r_34903.yh = v_f_34888, v_r_34903.Ch = v___34889, scope.v_xt_28153.T_(v_r_34903.A_), v_l_34848.push(v_r_34903), v_R_34844.xf.Gl("vertices")),
      ...
      for (; 0 < v_l_34848.length;) if ((v_a_34846 = v_l_34848[v_l_34848.length - 1]).Fh >= v_a_34846.Ih.We.length) v_a_34846.Bh || !v_a_34846.Mh || v_P_34911.kh <= 0 || (--v_P_34911.kh, v_st_34915()), v_l_34848.pop();else {
        if ((v_o_34847 = v_a_34846.Ih.We[v_a_34846.Fh]).visible) {
          ...
          if (!function (v_e_34926, v_n_34927, v_t_34928) {
          ...
          }(v_o_34847, v_s_34843 / 1e3, v_E_34853), v_D_34854.oh(v_E_34853), v_M_34851.ph = v_s_34843 / 1e3, v_J_34861 = v_t_34890 * v_o_34847.Fd[0], v_N_34857 = v_i_34891 * v_o_34847.Fd[1], v_o_34847.Bd ? scope.v_xt_28153.T_(v_F_34855) : scope.v_xt_28153.ih(v_a_34846.A_, v_F_34855), scope.v_xt_28153.on(v_F_34855, v_J_34861 + v_o_34847.x + v_E_34853.on[0], v_N_34857 + v_o_34847.y + v_E_34853.on[1], 0 + v_E_34853.on[2]), scope.v_xt_28153.vd(v_F_34855, v_E_34853.vd[0] * v_k_34901, v_E_34853.vd[1] * v_k_34901, v_E_34853.vd[2] * v_k_34901), scope.v_xt_28153.ah(v_F_34855, v_E_34853.gd[0] * v_k_34901, v_E_34853.gd[1] * v_k_34901), scope.v_xt_28153.Oe(v_F_34855, v_E_34853.Oe[0], v_E_34853.Oe[1], v_E_34853.Oe[2]), scope.v_xt_28153.on(v_F_34855, -v_J_34861, -v_N_34857, -0), v_M_34851.w = v_t_34890, v_M_34851.h = v_i_34891, v_M_34851.xh = v_D_34854, v_M_34851.A_ = v_F_34855, 0 < v_M_34851.xh.qe) switch (v_o_34847.Pd && !v_a_34846.Mh && (v_a_34846.Mh = !0, ++v_P_34911.kh), v_M_34851.bh = v_a_34846.Bh || v_o_34847.Pd, v_o_34847.Fi) {
            case 1:
              v_O_34863 = v_j_34862 = void 0;
              var v_j_34862 = v_o_34847,
                v_O_34863 = v_M_34851;
              v_pt_34916(v_j_34862.Fi), v_bt_34918(v_j_34862.Md), v_yt_34919(v_O_34863.bh), v_St_34920(!1), v_At_34921(), v_h_34892 = v_I_34910.Th, scope.v_al_28152.Q3(0, 0, 0, 1, v_m_34899), scope.v_xt_28153.rh(v_O_34863.A_, v_m_34899, v_p_34900), v_y_34904[3 * v_h_34892 + 0] = v_p_34900.m[0], v_y_34904[3 * v_h_34892 + 1] = -v_p_34900.m[1], v_y_34904[3 * v_h_34892 + 2] = v_p_34900.m[2], scope.v_al_28152.Q3(v_O_34863.w, 0, 0, 1, v_m_34899), scope.v_xt_28153.rh(v_O_34863.A_, v_m_34899, v_p_34900), v_y_34904[3 * v_h_34892 + 3] = v_p_34900.m[0], v_y_34904[3 * v_h_34892 + 4] = -v_p_34900.m[1], v_y_34904[3 * v_h_34892 + 5] = v_p_34900.m[2], scope.v_al_28152.Q3(0, v_O_34863.h, 0, 1, v_m_34899), scope.v_xt_28153.rh(v_O_34863.A_, v_m_34899, v_p_34900), v_y_34904[3 * v_h_34892 + 6] = v_p_34900.m[0], v_y_34904[3 * v_h_34892 + 7] = -v_p_34900.m[1], v_y_34904[3 * v_h_34892 + 8] = v_p_34900.m[2], scope.v_al_28152.Q3(v_O_34863.w, v_O_34863.h, 0, 1, v_m_34899), scope.v_xt_28153.rh(v_O_34863.A_, v_m_34899, v_p_34900), v_y_34904[3 * v_h_34892 + 9] = v_p_34900.m[0], v_y_34904[3 * v_h_34892 + 10] = -v_p_34900.m[1], v_y_34904[3 * v_h_34892 + 11] = v_p_34900.m[2];
            ...
            case 2:
              !function (v_n_34933, v_r_34934) {
                ...
                let v_s_34937 = 0,
                  ...
                  v_o_34939 = 1,
                  v_l_34940 = 1;
                !v_n_34933.zt && v_d_34895.rd[v_n_34933.Je] && (v_w_34897 = v_d_34895.rd[v_n_34933.Je], v_s_34937 = v_w_34897.ou / v_d_34895.w, v_a_34938 = v_w_34897.Oa / v_d_34895.h, v_o_34939 = (v_w_34897.ou + v_w_34897.w) / v_d_34895.w, v_l_34940 = (v_w_34897.Oa + v_w_34897.h) / v_d_34895.h);
                {
                ...
                if (v_n_34933.Yd) {
                  var v_u_34943 = [0, v_n_34933.$d[0], v_r_34934.w - v_n_34933.$d[2], v_r_34934.w, 0, v_n_34933.$d[1], v_r_34934.h - v_n_34933.$d[3], v_r_34934.h],
                    v_f_34944 = [v_s_34937, v_s_34937 + v_n_34933.$d[0] / v_d_34895.w, v_o_34939 - v_n_34933.$d[2] / v_d_34895.w, v_o_34939, v_a_34938, v_a_34938 + v_n_34933.$d[1] / v_d_34895.h, v_l_34940 - v_n_34933.$d[3] / v_d_34895.h, v_l_34940];
                  let v_t_34948 = 0,
                    v_i_34949 = 0,
                    v_e_34950 = 0;
                  ...
                  scope.v_al_28152.Q3(0, 0, 0, 1, v_m_34899), scope.v_xt_28153.rh(v_r_34934.A_, v_m_34899, v_p_34900), v_y_34904[3 * v_h_34892 + 0] = v_p_34900.m[0], v_y_34904[3 * v_h_34892 + 1] = -v_p_34900.m[1], v_y_34904[3 * v_h_34892 + 2] = v_p_34900.m[2], scope.v_al_28152.Q3(v_r_34934.w, 0, 0, 1, v_m_34899), scope.v_xt_28153.rh(v_r_34934.A_, v_m_34899, v_p_34900), v_y_34904[3 * v_h_34892 + 3] = v_p_34900.m[0], v_y_34904[3 * v_h_34892 + 4] = -v_p_34900.m[1], v_y_34904[3 * v_h_34892 + 5] = v_p_34900.m[2], scope.v_al_28152.Q3(0, v_r_34934.h, 0, 1, v_m_34899), scope.v_xt_28153.rh(v_r_34934.A_, v_m_34899, v_p_34900), v_y_34904[3 * v_h_34892 + 6] = v_p_34900.m[0], v_y_34904[3 * v_h_34892 + 7] = -v_p_34900.m[1], v_y_34904[3 * v_h_34892 + 8] = v_p_34900.m[2], scope.v_al_28152.Q3(v_r_34934.w, v_r_34934.h, 0, 1, v_m_34899), scope.v_xt_28153.rh(v_r_34934.A_, v_m_34899, v_p_34900), v_y_34904[3 * v_h_34892 + 9] = v_p_34900.m[0], v_y_34904[3 * v_h_34892 + 10] = -v_p_34900.m[1], v_y_34904[3 * v_h_34892 + 11] = v_p_34900.m[2];
            ...
            case 3:
              ...
              if (v_X_34866) {
                v_R_34844.Dh.M3(v_V_34864.R3, v_V_34864.I_), v_R_34844.Dh.P3(v_W_34865.w), v_R_34844.Dh.D3(v_W_34865.h), v_R_34844.Dh.N3(v_V_34864.w_), v_R_34844.Dh.H3(v_V_34864.F_), v_R_34844.Dh.U3(v_V_34864.B_, v_V_34864.M_), v_R_34844.Dh.V3(v_W_34865.A_), v_X_34866.X3(v_V_34864.Wt, v_V_34864.Vd, v_V_34864.Od, v_V_34864.Tn);
                ...
                if (v_V_34864.Jd && (v_W_34865 = v_W_34865.w / v_t_34952) < 1 && (v_X_34866.X3(v_V_34864.Wt, v_V_34864.Vd * v_W_34865, v_V_34864.Od, v_V_34864.Tn), v_X_34866.Z3(), v_t_34952 = v_X_34866.z_), v_R_34844.Dh.G3(0), v_R_34844.Dh.j3(0), v_V_34864.Nd && !v_V_34864.B_ && v_t_34952 > v_R_34844.Dh.y_) {
            ...
            case 4:
              ...
              if (v_vt_34886) {
                ...
                if (v_et_34884.R3 !== scope.v_Yo_28141) {
                  let v_t_34959 = 0;
                  for (v_n_34957 = 0; v_n_34957 < v_et_34884.Wt.length; ++v_n_34957) (v_i_34955 = v_vt_34886.Ik.get(v_et_34884.Wt.charCodeAt(v_n_34957))) && (v_r_34958 !== v_i_34955.Xt && (v_d_34895 = v_L_34845.Mf[v_i_34955.Xt], v_r_34958 = v_i_34955.Xt), v_d_34895) && void 0 !== (v_w_34897 = v_d_34895.rd[v_i_34955.Je]) && (v_t_34959 += v_w_34897.w * v_et_34884.Vd + v_et_34884.qd);
                  v_t_34959 -= v_et_34884.qd, v_et_34884.R3 === scope.v_qo_28142 ? v_e_34956 += (v_nt_34885.w - v_t_34959) / 2 : v_et_34884.R3 === scope.v_Zo_28143 && (v_e_34956 += v_nt_34885.w - v_t_34959);
                }
                for (v_pt_34916(v_et_34884.Fi), v_bt_34918(v_et_34884.Md), v_yt_34919(v_nt_34885.bh), v_St_34920(v_mt_34914(v_nt_34885)), v_r_34958 = "", v_n_34957 = 0; v_n_34957 < v_et_34884.Wt.length; ++v_n_34957) if ((v_i_34955 = v_vt_34886.Ik.get(v_et_34884.Wt.charCodeAt(v_n_34957))) && (v_r_34958 !== v_i_34955.Xt && (v_d_34895 = v_L_34845.Mf[v_i_34955.Xt], v_r_34958 = v_i_34955.Xt, v_kt_34917(v_d_34895.ed, !1), v_At_34921()), v_d_34895) && void 0 !== (v_w_34897 = v_d_34895.rd[v_i_34955.Je])) {
                  ...
                  v_A_34906[2 * v_h_34892 + 0] = v_tt_34878, v_A_34906[2 * v_h_34892 + 1] = v_it_34879, v_A_34906[2 * v_h_34892 + 2] = v_ft_34880, v_A_34906[2 * v_h_34892 + 3] = v_it_34879, v_A_34906[2 * v_h_34892 + 4] = v_tt_34878, v_A_34906[2 * v_h_34892 + 5] = v__t_34881, v_A_34906[2 * v_h_34892 + 6] = v_ft_34880, v_A_34906[2 * v_h_34892 + 7] = v__t_34881, v_e_34956 += v_w_34897.w * v_et_34884.Vd + v_et_34884.qd, v_I_34910.Th += 4, ++v_R_34844.Ph.Rh;
                }
              }
              break;
            case 5:
              v_u_34850 = v_M_34851, 0 != (v_c_34849 = v_o_34847).Qd && (v_st_34915(), (1 == v_c_34849.Qd ? function (v_t_34961, v_i_34962) {
                ...
                scope.v_al_28152.Q3(0, 0, 0, 1, v_m_34899), scope.v_xt_28153.rh(v_i_34962.A_, v_m_34899, v_p_34900), v_c_34970[0] = v_p_34900.m[0], v_c_34970[1] = v_p_34900.m[1], v_c_34970[2] = v_p_34900.m[2], scope.v_al_28152.Q3(v_i_34962.w, 0, 0, 1, v_m_34899), scope.v_xt_28153.rh(v_i_34962.A_, v_m_34899, v_p_34900), v_c_34970[3] = v_p_34900.m[0], v_c_34970[4] = v_p_34900.m[1], v_c_34970[5] = v_p_34900.m[2], scope.v_al_28152.Q3(0, v_i_34962.h, 0, 1, v_m_34899), scope.v_xt_28153.rh(v_i_34962.A_, v_m_34899, v_p_34900), v_c_34970[6] = v_p_34900.m[0], v_c_34970[7] = v_p_34900.m[1], v_c_34970[8] = v_p_34900.m[2], scope.v_al_28152.Q3(v_i_34962.w, v_i_34962.h, 0, 1, v_m_34899), scope.v_xt_28153.rh(v_i_34962.A_, v_m_34899, v_p_34900), v_c_34970[9] = v_p_34900.m[0], v_c_34970[10] = v_p_34900.m[1], v_c_34970[11] = v_p_34900.m[2];
                {
                ...
                scope.v_al_28152.Q3(0, 0, 0, 1, v_m_34899), scope.v_xt_28153.rh(v_e_34976.A_, v_m_34899, v_p_34900), v_t_34977[0] = v_p_34900.m[0], v_t_34977[1] = -v_p_34900.m[1], v_t_34977[2] = v_p_34900.m[2], scope.v_al_28152.Q3(v_e_34976.w, 0, 0, 1, v_m_34899), scope.v_xt_28153.rh(v_e_34976.A_, v_m_34899, v_p_34900), v_t_34977[3] = v_p_34900.m[0], v_t_34977[4] = -v_p_34900.m[1], v_t_34977[5] = v_p_34900.m[2], scope.v_al_28152.Q3(0, v_e_34976.h, 0, 1, v_m_34899), scope.v_xt_28153.rh(v_e_34976.A_, v_m_34899, v_p_34900), v_t_34977[6] = v_p_34900.m[0], v_t_34977[7] = -v_p_34900.m[1], v_t_34977[8] = v_p_34900.m[2], scope.v_al_28152.Q3(v_e_34976.w, v_e_34976.h, 0, 1, v_m_34899), scope.v_xt_28153.rh(v_e_34976.A_, v_m_34899, v_p_34900), v_t_34977[9] = v_p_34900.m[0], v_t_34977[10] = -v_p_34900.m[1], v_t_34977[11] = v_p_34900.m[2], v_r_34979[0] = v_t_34977[0] / v_f_34888, v_r_34979[1] = 1 + v_t_34977[1] / v___34889, v_r_34979[2] = v_t_34977[3] / v_f_34888, v_r_34979[3] = 1 + v_t_34977[4] / v___34889, v_r_34979[4] = v_t_34977[6] / v_f_34888, v_r_34979[5] = 1 + v_t_34977[7] / v___34889, v_r_34979[6] = v_t_34977[9] / v_f_34888, v_r_34979[7] = 1 + v_t_34977[10] / v___34889;
  ...
  scope.v_ie_27875(), scope.v_Oa_28077(function (v_t_35153, v_i_35154) {
    ...
    scope.languagePackages.it("ui/startup.rsb", function (v_t_35165) {
      v_t_35165 ? (v_t_35165 = new scope.v_Dl_28181(v_t_35165), scope.renderer.ut("startup", v_t_35165.rt(scope.renderer.p5()), 0, v_t_35166 => {
        (v_r_35144 = v_t_35166).e8(1), v_r_35144.e8(0), v_e_35145 = v_r_35144.rsbTree.elementByIndex(4), v_n_35146 = v_r_35144.rsbTree.elementByIndex(5), v_s_35147 = v_r_35144.rsbTree.elementByIndex(7), v_r_35144.rsbTree.elementByIndex(17).visible = !1, v_n_35146.visible = !1, scope.v_Me_28078(v_i_35164);
      })) : scope.v_k1_27883();
    });
  }, function (v_t_35167) {
    ...
    v_c_35151(scope.v_Ue_28209("startupResources")), scope.v_Ae_27892.ue(function () {
    ...
    if (v_c_35151(scope.v_Ue_28209("startupInitDevices")), scope.inputModule.ue(), scope.inputModule.fe(scope.handshake.rm.dm), 1 === scope.handshake.rm.b7) v_c_35151(scope.v_Ue_28209("startupLedServer")), scope.ledOutput.ue(function (v_t_35209) {
      ...
      if (2 === scope.handshake.rm.b7) {
        ...
        for (let v_t_35210 = 4; 0 <= v_t_35210; --v_t_35210) v_r_35144.rsbTree.elementByIndex(21).Wt = scope.v_Ba_28069(scope.v_Ue_28209("sysMsgDevInit2"), [["TIME", v_t_35210]]), await scope.renderer.C7(1e3);
        var v_t_35206 = new scope.v_Ss_28000(scope.handshake.rm.A7);
        if (await v_t_35206.ue()) {
          v_r_35144.rsbTree.elementByIndex(21).Wt = scope.v_Ue_28209("sysMsgDevInit2Ok"), (scope.boardLanes = v_t_35206).BR(), scope.boardLanes.o9();
          var v_e_35207 = new scope.v_As_28001(scope.handshake.rm.S7);
          if (await v_e_35207.ue()) {
            if (v_r_35144.rsbTree.elementByIndex(23).Wt = "GOOD", (scope.boardAir = v_e_35207).H9(), scope.boardAir.o9(), scope.handshake.rm.A9) {
              ...
              if (!(await v_n_35208.ue())) return v_n_35208.V7(), scope.boardLanes.V7(), scope.boardLanes = null, scope.boardAir.V7(), scope.boardAir = null, v_r_35144.rsbTree.elementByIndex(25).Wt = "BAD", await scope.renderer.C7(2e3), void scope.v_Me_28078(v_i_35205);
              if (v_r_35144.rsbTree.elementByIndex(25).Wt = "GOOD", scope.v_D_27646 = v_n_35208, scope.handshake.rm.OA) {
                v_n_35208 = new scope.v_xs_28002(scope.handshake.rm.OA);
                if (!(await v_n_35208.ue())) return v_n_35208.V7(), v_r_35144.rsbTree.elementByIndex(27).Wt = "BAD", await scope.renderer.C7(2e3), void scope.v_Me_28078(v_i_35205);
                v_r_35144.rsbTree.elementByIndex(27).Wt = "GOOD", scope.v_F_27647 = v_n_35208, scope.v_D_27646.HS(scope.v_F_27647);
              }
            }
          } else v_e_35207.V7(), scope.boardLanes.V7(), scope.boardLanes = null, v_r_35144.rsbTree.elementByIndex(23).Wt = "BAD";
    ...
    scope.v_D_27646 || (scope.v_D_27646 = new scope.v_Ls_28008()).ue(), v_r_35144.rsbTree.elementByIndex(17).visible = !1, scope.v_Me_28078(v_t_35211);
  }, function (v_t_35212) {
    scope.menuSystem.ue(() => {
    ...
    scope.v_R1_27896.ue(), scope.testMenu.Ju(), scope.v_D_27646.jS(), v_i_35143 ? scope.v_F1_27902.T0(async () => {
      await scope.v_Ns_28014.cA(), scope.playerInfoBoard.N4(scope.handshake.rm.om), scope.playerInfoBoard.H4(scope.handshake.On.$p), await scope.playerInfoBoard.V4(scope.handshake.On.qp), scope.playerInfoBoard.U4(scope.handshake.On.im), scope.playerInfoBoard.J4(scope.handshake.rm.lm, scope.v_Ie_27966.D0("showRating")), scope.playerInfoBoard.O4(scope.handshake.rm.um, scope.v_Ie_27966.D0("showLevel")), scope.playerInfoBoard.ti(), scope.v__s_27989.ue(), scope.gameCore.lg();
