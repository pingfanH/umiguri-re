...
export function createUiComponentA(scope) {
  ...
  function v_s_29556() {
    scope.v_el_28148(v_u_29549.lt.yk(70), v_v_29555.Bn, !0);
  }
  function v_a_29557() {
    return !!v_v_29555.Ui;
  }
  ...
  function v_y_29564(v_t_29588) {
    if (v_v_29555.n1 === v_e_29544) switch (v_t_29588) {
      ...
      case "exceedLimit":
        ...
        return v_k_29562(), v_s_29556(), v_u_29549.lt.yk(64).Be = !0, v_u_29549.e8(9), scope.menuSystem.Ct(!0), void scope.renderer.W6(() => {
      ...
      case "changeUp":
        ...
        break;
      case "enter":
        return scope.v_Ae_27892.dn("menu_in"), scope.menuSystem._t(), v_v_29555.n1 = v_e_29544, v_u_29549.e8(3), scope.v_el_28148(v_u_29549.lt.yk(44), v_v_29555.Bn, !0), scope.menuSystem.Ct(!0), void scope.renderer.W6(() => {
          scope.menuSystem.Ct(!1);
        }, scope.v_Ge_28204(30));
    }
    v_k_29562();
  ...
  function v_S_29565() {
    ...
    v___29552.Rn.Be = v___29552.B5.Be = !v_v_29555.Mn.ub, v___29552.fb.Be = v___29552._b.Be = v_v_29555.Mn.ub, scope.renderer.Yt.Zt[v_r_29546 + v_t_29592] && (v_v_29555.Mn.ub ? (v___29552.fb.zt = !0, v___29552.fb.Xt = v_r_29546 + v_t_29592, v___29552._b.zt = !0, v___29552._b.Xt = v_r_29546 + v_t_29592) : (v___29552.Rn.zt = !0, v___29552.Rn.Xt = v_r_29546 + v_t_29592, v___29552.B5.zt = !0, v___29552.B5.Xt = v_r_29546 + v_t_29592)), v___29552.Pn.Be = !!v_v_29555.Bn && 0 < v_v_29555.Bn.jm, scope.v_nl_28149(v___29552.Dn, v_v_29555.Fn[v_v_29555.Ni]);
  }
  return {
    ...
    T0: function (v_s_29600, v_a_29601, v_t_29602) {
      scope.v_Le_28076([v_i_29603 => {
        ...
        v_m_29560(), v_S_29565(), scope.v_el_28148(v_u_29549.lt.yk(44), v_a_29601, !0);
        ...
        scope.menuSystem.yv(), v_k_29562(), scope.sceneManager.ft(new scope.v_M1_27898(v_b_29563, void 0)), v_u_29549.lt.yk(64).Be = !1, v_u_29549.Jt = !0, v_u_29549.e8(2), v_u_29549.e8(0), scope.menuSystem.Ct(!0), scope.renderer.W6(() => {
