...
export function createV_G1_27905(scope) {
  ...
  async function v_i_28806() {
    if (1 <= scope.handshake.On.Kp || (await new Promise(async v_i_28812 => {
      ...
      scope.handshake.On.Kp = 1, scope.handshake.On.zp && scope.v_Xt_27648 && (await new Promise(v_t_28823 => scope.v_Te_27911.Ai(scope.v_Ue_28209("entryCreateData"), scope.v_ei_27773 | scope.v_it_27778, 2e3, v_t_28823)), await scope.renderer.C7(scope.v_Ge_28204(30)), await new Promise(v_t_28824 => scope.coopLobby.T0(v_t_28824)), await scope.renderer.C7(scope.v_Ge_28204(30))), await scope.v_Ns_28014.uA();
      {
        ...
        0 === v_i_28825.length ? (v_b_28810(), v_v_28803()) : (v_f_28794.visible = !1, v_n_28795.visible = !1, v_s_28796.visible = !1, scope.menuSystem.dt(), scope.menuSystem.vt("ok", "Next", 0, 16, scope.v_W0_27791, !1, !1, !1, "", scope.v_fc_28212), scope.v_Le_28076([function (v_t_28829) {
          v_n_28795.visible = !0, v_u_28793.e8(13), scope.renderer.W6(function () {
            v_n_28795.visible = !1, scope.v_Me_28078(v_t_28829);
          }, scope.v_Ge_28204(80));
        }, function (v_t_28830) {
          scope.v_lo_28099(v_i_28825, function (v_i_28831, v_t_28832, v_e_28833) {
            v_e_28833.gi.pi(v_e_28833.wi.ki).then(function (v_t_28834) {
              if (v_t_28834) {
                ...
                }), v_n_28835 ? (scope.renderer.Yt.Zt[v_r_28792] && scope.renderer.Yt.Zt[v_r_28792].free(), scope.renderer.Yt.Zt[v_r_28792] = v_n_28835, v_s_28796.elementByIndex(25).zt = !0, v_s_28796.elementByIndex(25).Xt = v_r_28792, scope.v_Ae_27892.dn("news_open"), v_s_28796.visible = !0, v_u_28793.e8(12), scope.renderer.W6(function () {
  ...
  async function v_p_28808(v_t_28842) {
    ...
    v_t_28842.visible = !scope.v_Ns_28014.wA(), v_e_28845.visible = scope.v_Ns_28014.wA(), v_f_28794.elementByIndex(20).Wt = scope.v_Ue_28209(scope.v_Ns_28014.wA() ? "loginMessageGuest" : "loginMessage");
    {
      let v_i_28859 = v_r_28844.titleId;
      v_e_28845 = scope.v_be_27857.Hp.find(v_t_28860 => v_t_28860.id === v_i_28859);
      v_e_28845 ? (v_t_28842.elementByIndex(15).Wt = v_e_28845.text, v_t_28842.elementByIndex(10).Je = "title" + scope.v_ot_27785[v_e_28845.rarity]) : (v_t_28842.elementByIndex(15).Wt = "！！データベース参照エラー！！", v_t_28842.elementByIndex(10).Je = "title" + scope.v_ot_27785[0]);
    }
    ...
    var v_i_28846,
      ...
      v_e_28845 = (scope.renderer.Yt.Zt[v_c_28791 + "0"] && (v_n_28843 ? (v_e_28845.visible = !1, v_a_28848.visible = !0, v_a_28848.zt = !0, v_a_28848.Xt = v_c_28791 + "0") : (v_e_28845.visible = !0, v_a_28848.visible = !1, v_e_28845.zt = !0, v_e_28845.Xt = v_c_28791 + "0")), scope.v_Ie_27966.D0("showRating") ? (v_a_28848 = v_r_28844.playerRating, v_e_28845 = "" + scope.mathFloor(v_a_28848 / 100), v_i_28846 = scope.v_Xa_28081("" + v_a_28848 % 100, 2, "0"), v_s_28847 = scope.ratingColorName(v_a_28848), v_a_28848 = scope.ratingColorRgba(v_a_28848), v_t_28842.elementByIndex(14).Wt = v_e_28845 + "P" + v_i_28846, v_t_28842.elementByIndex(14).Ak = "rating" + v_s_28847, v_t_28842.elementByIndex(14).Qe(v_a_28848[0], v_a_28848[1], v_a_28848[2], v_a_28848[3]), v_t_28842.elementByIndex(13).Je = "numRating" + v_s_28847 + "Rating", v_t_28842.elementByIndex(13).Qe(v_a_28848[0], v_a_28848[1], v_a_28848[2], v_a_28848[3])) : (v_t_28842.elementByIndex(14).Wt = "N", v_t_28842.elementByIndex(14).Ak = "ratingWt", v_t_28842.elementByIndex(14).Qe(.825, .825, .825, 1), v_t_28842.elementByIndex(13).Je = "numRatingWtRating", v_t_28842.elementByIndex(13).Qe(.825, .825, .825, 1)), scope.v_Ie_27966.D0("showLevel") ? v_t_28842.elementByIndex(12).Wt = "" + scope.mathMin(scope.mathMax(v_r_28844.playerLevel, 1), 99) : v_t_28842.elementByIndex(12).Wt = "MM", v_d_28802(v_f_28794), v_u_28793.e8(6, void 0, 25), scope.v_H1_27907.T0(), scope.menuSystem.dt(), [["yes", "Yes", 0, 8, scope.v_W0_27791, async function () {
      ...
      for (const v_n_28865 of [["guest", "GuestLogin", 0, 12, scope.v_W0_27791, async function () {
        ...
        scope.v_D_27646.C9(), scope.sceneManager.ni(), scope.sceneManager.ii(), scope.menuSystem.It(!1), v_u_28793.e8(9, void 0, 0), await scope.renderer.C7(scope.v_Ge_28204(15)), scope.menuSystem.dt(), async function () {
          ...
          if (v_i_28867 !== scope.v_Ts_28004) if (v_i_28867 === scope.v_Is_28005) await new Promise(v_t_28871 => scope.v_Te_27911.Ai(scope.v_Ue_28209("amReaderErrorFatal"), scope.v_N0_27771 | scope.v_U0_27775, 1500, v_t_28871)), v_e_28868();else {
            v_u_28793.e8(1, void 0, 10), scope.sceneManager.ni(), scope.sceneManager.ii(), scope.menuSystem.It(!1), await scope.renderer.C7(scope.v_Ge_28204(30)), scope.menuSystem.dt(), v_t_28866++, v_d_28802(v___28800), v_u_28793.rsbTree.elementByIndex(50).Wt = scope.v_Rs_28007.E9(v_i_28867), v_u_28793.e8(2, void 0, 10);
