    ...
    if (0 < v_t_29509.Bi.length) {
      ...
      for (let v_e_29517 = 0; v_e_29517 < v_u_29469.Cn.We.length; ++v_e_29517) {
        ...
        var v_o_29511 = (v_r_29515 = v_u_29469.Cn.We[v_e_29517]).elementByName("musicItemLevel"),
          ...
          v_a_29510 = (v_t_29518 && v_s_29516 ? (v_r_29515.elementByName("musicItemBg").Je = "musicFrame_" + scope.v_Q0_27805[v_i_29519], scope.renderer.Yt.Zt["jkt:" + v_t_29518.w0] ? (v_r_29515.elementByName("musicItemJacket").zt = !0, v_r_29515.elementByName("musicItemJacket").Xt = "jkt:" + v_t_29518.w0) : (v_r_29515.elementByName("musicItemJacket").zt = !1, v_r_29515.elementByName("musicItemJacket").Xt = "txDummyJacket"), v_r_29515.elementByName("musicItemTitle").Wt = v_t_29518.lf, v_r_29515.elementByName("musicItemLevelBg").Je = 4 !== v_i_29519 ? "panelPartLevel" : "panelPartLevelWe", 4 !== v_i_29519 ? (v_o_29511.visible = !0, v_l_29512.visible = !1, v_o_29511.elementByName("musicItemLevelNum").Wt = v_s_29516.k5.replace(/\+/g, ""), v_o_29511.elementByName("musicItemLevelPlus").visible = -1 !== v_s_29516.k5.indexOf("+")) : (v_o_29511.visible = !1, v_l_29512.visible = !0, v_l_29512.elementByName("musicItemWeLevelNum").Wt = "r".repeat(scope.v_Qa_28089(scope.v_Pe_28064(v_s_29516.k5), 1, 5)), v_l_29512.elementByName("musicItemWeAttr").Wt = v_s_29516.b5)) : v_a_29510 === scope.v_Sr_27945 ? (v_r_29515.elementByName("musicItemBg").Je = "musicFrame_RND0", v_r_29515.elementByName("musicItemJacket").zt = !1, v_r_29515.elementByName("musicItemJacket").Xt = "txRandomJacket", v_r_29515.elementByName("musicItemTitle").Wt = "", v_r_29515.elementByName("musicItemLevelBg").Je = "panelPartLevel", v_o_29511.visible = !0, v_l_29512.visible = !1, v_o_29511.elementByName("musicItemLevelNum").Wt = v_n_29514.hI[v_e_29517].p9.replace(/\+/g, ""), v_o_29511.elementByName("musicItemLevelPlus").visible = -1 !== v_n_29514.hI[v_e_29517].p9.indexOf("+")) : (v_a_29510 === scope.v_Ar_27946 ? (v_r_29515.elementByName("musicItemBg").Je = "musicFrame_RND1", v_r_29515.elementByName("musicItemJacket").zt = !1, v_r_29515.elementByName("musicItemJacket").Xt = "txRandomJacket1", v_r_29515.elementByName("musicItemTitle").Wt = "", v_r_29515.elementByName("musicItemLevelBg").Je = "panelPartLevel", v_o_29511.elementByName("musicItemLevelNum").Wt = "M") : (v_r_29515.elementByName("musicItemBg").Je = "musicFrame_BAS", v_r_29515.elementByName("musicItemJacket").zt = !1, v_r_29515.elementByName("musicItemJacket").Xt = "txRandomJacket", v_r_29515.elementByName("musicItemTitle").Wt = "(Not Found)", v_r_29515.elementByName("musicItemLevelBg").Je = "panelPartLevel", v_o_29511.elementByName("musicItemLevelNum").Wt = "Q"), v_o_29511.elementByName("musicItemLevelPlus").visible = !1, v_o_29511.visible = !0, v_l_29512.visible = !1), scope.v_Ns_28014.gA(v_n_29514.Ae));
        v_u_29469.mn.elementByIndex(55).visible = v_a_29510.ni, (v_r_29515 = v_u_29469.mn.elementByIndex(56)).Je = "badge" + scope.rankLabel(v_a_29510.Sr / 3), v_r_29515.visible = v_a_29510.G4, v_r_29515 = v_u_29469.mn.elementByIndex(57), v_a_29510.B4 ? v_r_29515.Je = "badgeAj" : v_a_29510.R4 && (v_r_29515.Je = "badgeFc"), v_r_29515.visible = v_a_29510.G4 && (v_a_29510.B4 || v_a_29510.R4), v_u_29469.mn.elementByIndex(54).Wt = v_a_29510.Sr.toLocaleString("ja").replaceAll(",", "C");
      }
  ...
  function v_k_29482() {
    ...
    for (let v_t_29526 = 0; v_t_29526 < scope.v_be_27857.Gp.length; ++v_t_29526) {
      ...
      for (v_i_29521 of scope.v_be_27857.Gp[v_t_29526].items) {
        (v_e_29522 = new v_a_29464()).vn = v_i_29521, v_e_29522.ze = v_f_29470.listItem.Ve(!0), v_e_29522.ze.elementByName("listItemBg").Je = "cousePanel" + v_i_29521.AP, v_e_29522.ze.elementByName("listItemTitle").Wt = v_i_29521.lf, v_e_29522.ze.elementByName("listItemBgDisabled").visible = !1, v_i_29521.hI[0].Fi === scope.v_yr_27944 && scope.renderer.Yt.Zt["jkt:" + v_i_29521.hI[0].ee] ? (v_e_29522.ze.elementByName("listItemJacket").zt = !0, v_e_29522.ze.elementByName("listItemJacket").Xt = "jkt:" + v_i_29521.hI[0].ee) : v_i_29521.hI[0].Fi === scope.v_Sr_27945 ? (v_e_29522.ze.elementByName("listItemJacket").zt = !1, v_e_29522.ze.elementByName("listItemJacket").Xt = "txRandomJacket") : v_i_29521.hI[0].Fi === scope.v_Ar_27946 && (v_e_29522.ze.elementByName("listItemJacket").zt = !1, v_e_29522.ze.elementByName("listItemJacket").Xt = "txRandomJacket1");
        var v_r_29524 = scope.v_Ns_28014.gA(v_i_29521.Ae);
        let v_t_29527;
        v_e_29522.ze.elementByName("listItemBadgeClear").visible = v_r_29524.ni, (v_t_29527 = v_e_29522.ze.elementByName("listItemBadgeRank")).Je = "badgeSm" + scope.rankLabel(v_r_29524.Sr / 3), v_t_29527.visible = v_r_29524.G4, v_t_29527 = v_e_29522.ze.elementByName("listItemBadgeFc"), v_r_29524.B4 ? v_t_29527.Je = "badgeSmAj" : v_r_29524.R4 && (v_t_29527.Je = "badgeSmFc"), v_t_29527.visible = v_r_29524.G4 && (v_r_29524.B4 || v_r_29524.R4), v___29471[v_n_29523].Bi.push(v_e_29522);
      }
    }
  }
