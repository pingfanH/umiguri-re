...
export function createPlayerInfoBoard(scope) {
  ...
  return {
      ...
      scope.v_Le_28076([v_i_28610 => {
        ...
        scope.languagePackages.it("ui/commonIndicator.rsb", function (v_t_28614) {
          v_t_28614 ? (v_t_28614 = new scope.v_Dl_28181(v_t_28614), scope.renderer.ut("sysIndicator", v_t_28614.rt(scope.renderer.p5()), 1001, v_t_28615 => {
            (v_n_28608 = v_t_28615).lt.yk(5).Be = !1, v_n_28608.lt.yk(2).Be = !1, v_n_28608.lt.yk(0).Be = !1, v_n_28608.lt.yk(3).Be = !1, v_n_28608.lt.yk(4).Be = !1, v_n_28608.lt.yk(1).Be = !1, scope.v_Me_28078(v_i_28613);
          })) : v_e_28609();
        });
      }, v_t_28616 => {
    ...
    j4: function (v_t_28618, v_i_28619) {
      v_r_28607.lt.Kt(), v_r_28607.lt.yk(5).Je = "title" + scope.v_ot_27785[v_i_28619], v_r_28607.lt.yk(11).Wt = v_t_28618;
    },
    ...
    U4: function (v_t_28623) {
      var v_i_28624;
      "string" == typeof v_t_28623 && (v_i_28624 = scope.v_Dr_27956(v_t_28623), v_r_28607.lt.yk(10).zt = !0, v_r_28607.lt.yk(10).Xt = "chara:" + v_i_28624 + ":0:" + v_t_28623);
    },
