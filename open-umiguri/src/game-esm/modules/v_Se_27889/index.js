...
export function createV_Se_27889(scope) {
  let v_e_28244,
    v_i_28245,
    v_n_28246,
    v_r_28247,
  ...
  return v_h_28256.prototype = {
    ...
    Q4: function (v_t_28261) {
      return new Promise(v_i_28262 => {
        scope.v_$r_27975.it(v_t_28261, async v_t_28263 => {
    ...
    mv: function (v_t_28267) {
      return new Promise(v_i_28268 => {
        null === v_t_28267 ? v_i_28268(0) : v_e_28244.decodeAudioData(v_t_28267.buffer || v_t_28267, function (v_t_28269) {
          ...
          v_s_28248.set(v_a_28249, v_t_28269), v_l_28251.set(v_a_28249, new scope.v_C1_27890(v_t_28269.th)), ++v_a_28249, v_i_28268(v_a_28249 - 1);
        }, () => v_i_28268(0));
      });
    },
    ...
    dn: function (v_i_28271, v_e_28272) {
      if (v_s_28248.has(v_i_28271)) {
        ...
        v_t_28273.o1() || (v_e_28272 ? scope.v_uo_28102(() => {
    ...
    o6: function (v_t_28283, v_i_28284) {
      var v_e_28285;
      v_s_28248.has(v_t_28283) && ((v_e_28285 = v_s_28248.get(v_t_28283)).l6 = v_i_28284, v_e_28285.o1() && (this.i6(v_t_28283), this.dn(v_t_28283)), v_l_28251.get(v_t_28283).l6 = scope.mathFloor(v_i_28284 * v_c_28252));
    },
    ...
    u6: function (v_t_28287, v_i_28288, v_e_28289) {
      var v_n_28290;
      v_s_28248.has(v_t_28287) && ((v_n_28290 = v_s_28248.get(v_t_28287)).vv && (v_n_28290.vv.loop = v_i_28288, v_n_28290.vv.loopStart = v_i_28288 ? (v_e_28289 || 0) / 1e3 : 0, v_n_28290.vv.loopEnd = v_n_28290.th.duration), v_n_28290._6 = v_i_28288 ? (v_e_28289 || 0) / 1e3 : -1, v_l_28251.get(v_t_28287)._6 = v_i_28288 ? scope.mathFloor((v_e_28289 || 0) * v_c_28252 / 1e3) : -1);
    },
    ...
    p6: function () {
      v_o_28250 = new scope.v_T1_27891(v_c_28252, 60), this.bv(!0);
    },
    k6: function () {
      if (v_o_28250) return v_o_28250.b6(), v_o_28250.m6(), v_o_28250.S6();
    },
    dv: function () {
      return 2 * scope.mathFloor(v_c_28252 / 60) * 2;
    },
    C6: function () {
