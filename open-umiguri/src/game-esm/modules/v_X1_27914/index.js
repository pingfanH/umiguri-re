...
export function createV_X1_27914(scope) {
  ...
  function v_f_29134(v_t_29141) {
    switch (v_t_29141) {
      ...
      case "enter":
        !async function () {
          scope.menuSystem.It(!1), v_r_29127.rsbTree.elementByIndex(30).visible = !1, v_r_29127.rsbTree.elementByIndex(15).visible = !1;
  ...
  function v_i_29135() {
    scope.sceneManager._t(), scope.menuSystem.It(!1), v_r_29127.e8(7), v_r_29127.rsbTree.elementByIndex(30).visible = !1, v_r_29127.rsbTree.elementByIndex(15).visible = !1, scope.renderer.W6(() => {
  ...
  return {
      ...
      scope.v_Le_28076([v_i_29144 => {
        scope.languagePackages.it("ui/openCoop.rsb", function (v_t_29145) {
          v_t_29145 ? (v_t_29145 = new scope.v_Dl_28181(v_t_29145), scope.renderer.nt(v_t_29145.rt(scope.renderer.p5()), v_t_29146 => {
            v_r_29127 = v_t_29146, v_s_29128.push(v_r_29127.rsbTree.elementByIndex(19)), v_s_29128.push(v_r_29127.rsbTree.elementByIndex(21)), v_s_29128.push(v_r_29127.rsbTree.elementByIndex(23)), v_s_29128.push(v_r_29127.rsbTree.elementByIndex(25)), v_s_29128.push(v_r_29127.rsbTree.elementByIndex(27)), v_s_29128.push(v_r_29127.rsbTree.elementByIndex(29)), scope.v_Me_28078(v_i_29144);
          })) : v_e_29143();
        });
      }, v_t_29147 => {
    ...
    T0: async function (v_t_29148, v_i_29149) {
      (v_a_29129 = new v_n_29126()).Gi = !0, v_a_29129.YS = v_t_29148, v_a_29129.qS = v_i_29149, v_r_29127.Jt = !1, await new Promise(v_t_29150 => scope.renderer.ut("openCoop", v_r_29127, 60, v_t_29150)), v_r_29127.rsbTree.elementByIndex(30).visible = !0, v_r_29127.rsbTree.elementByIndex(15).visible = !0, v_o_29130(0), v_l_29131(!1, !0), scope.menuSystem.ft();
