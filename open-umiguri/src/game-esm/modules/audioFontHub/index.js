...
export function createAudioFontHub(scope) {
  ...
  function v_s_29230(v_t_29242) {
    ...
    80 <= v_o_29226.oL.length && (v_i_29243 = v_o_29226.oL.shift()).hL && v_c_29225.lt.yk(11).Ke(v_i_29243.hL), v_t_29242.hL = function (v_t_29244) {
      ...
      v_n_29247.ot("chatItemInfo").Wt = v_a_29250 ? scope.v_sc_28205(v_t_29244.iL) + " - " + v_f_29234(v_t_29244.nx) : v_f_29234(v_t_29244.nx) + " - " + scope.v_sc_28205(v_t_29244.iL);
      ...
      }(v_t_29244.nx), v_s_29249.X3(v_t_29244.Wt, v_r_29248.Vd, v_r_29248.Od, v_r_29248.Tn), v_s_29249.Z3(), v_l_29252.Wt = v_t_29244.Wt, v_l_29252.Le = scope.mathCeil(v_s_29249.z_), v_l_29252.G0 = scope.mathCeil(v_s_29249.Z_), v_o_29251.Le = v_l_29252.Le + 30, v_o_29251.G0 = v_l_29252.G0 + 36, v_a_29250 && (v_e_29246.Te = 816 - v_o_29251.Le);
  ...
  function v_u_29233(v_t_29273, v_i_29274) {
    var v_e_29275;
    (v_o_29226.Gi && v_o_29226.eL !== v_t_29273 || v_i_29274) && (v_o_29226.eL !== v_t_29273 && v_c_29225.e8(v_t_29273 ? 1 : 0), v_o_29226.eL = v_t_29273, v_c_29225.lt.yk(3).Be = !0, scope.menuSystem.Ct(v_t_29273), v_i_29274 = v_c_29225.lt.yk(3).Te, v_e_29275 = v_c_29225.lt.yk(3).Qt, v_i_29274 += v_c_29225.lt.yk(6).Te, v_e_29275 += v_c_29225.lt.yk(6).Qt, v_i_29274 += v_c_29225.lt.yk(15).Te, v_e_29275 += v_c_29225.lt.yk(15).Qt, v_n_29227.tabIndex = -1, v_n_29227.style.width = v_c_29225.lt.yk(15).Le + "px", v_n_29227.style.height = "48px", v_n_29227.style.display = v_t_29273 ? "block" : "none", v_n_29227.style.position = "absolute", v_n_29227.style.border = "none", v_n_29227.style.outline = "none", v_n_29227.style.background = "transparent", v_n_29227.style.font = "500 24px system-ui", v_n_29227.style.padding = "0 20px", v_n_29227.style.zIndex = "1000", v_n_29227.style.left = v_i_29274 + "px", v_n_29227.style.top = v_e_29275 + "px", v_t_29273 ? (v_a_29232(), v_l_29231(!1), v_r_29228(), scope.v_y_27559.appendChild(v_n_29227), v_n_29227.focus(), v_o_29226.rL = !1, v_o_29226.oL.length && (v_o_29226.sL = v_o_29226.oL[v_o_29226.oL.length - 1].tL), scope.sceneManager.ft(new scope.v_M1_27898(() => {
      v_u_29233(!1, !0);
  ...
  return v_n_29227.addEventListener("keydown", function (v_i_29278) {
    ...
    T0: function () {
      v_o_29226.Gi || (v_o_29226.Gi = !0, v_c_29225.Jt = !0, v_c_29225.lt.yk(3).Be = !1, v_l_29231(v_o_29226.rL), v_o_29226.rL = !1, scope.inputModule.$I("textChat", v_i_29229));
    },
    XS: function () {
      v_o_29226.Gi && (v_u_29233(!1), v_l_29231(!1), v_c_29225.lt.yk(3).Be = !1, v_o_29226.Gi = !1, v_c_29225.Jt = !1, scope.inputModule.ZI("textChat"));
    },
    B3: function () {
