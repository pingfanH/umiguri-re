...
// 说明: 本文件是 bundle 片段, 由 build/assemble-game.mjs 按 manifest 拼接;请勿手改拼接顺序。
  ...
  function v_fr_27933() {
    this.Ae = 0, this.Fi = v_An_27660, this.Xg = 0, this.ou = 0, this.Le = 0, this.G0 = 0, this.Lw = 0, this.Jg = 0, this.Yg = 0, this.We = [], this.od = 0, this.Pg = 0, this.Og = 0, this.Rw = 1, this.CL = 0, this.pw = !1, this.dw = v_An_27660, this.Vg = !1, this.gw = !1, this.jg = Array.from({
      length: 16
    ...
    this.Vw = function (v_t_31999) {
      ...
      for (let v_t_32009 = 0; v_t_32009 < v_o_32008.length; ++v_t_32009) if ((v_s_32006 = v_o_32008[v_t_32009]).Fi !== v_c0_27703) {
        if (v_s_32006.od >= v_i_32002) {
          v_r_32005 = v_e_32003.ou === v_s_32006.ou && v_e_32003.Le === v_s_32006.Le ? (v_s_32006.Fi !== v_jn_27680 && v_s_32006.Fi !== v_Wn_27684 && v_s_32006.Fi !== v_e0_27695 || (v_n_32004 = v_s_32006), {
            rw: v_s_32006.ou,
            aw: v_s_32006.ou + v_s_32006.Le,
            G0: v_s_32006.G0,
            cr: v_n_32004
          }) : (v_a_32007 = v_me_27822(v_pe_27823((v_i_32002 - v_e_32003.od) / (v_s_32006.od - v_e_32003.od), 0), 1), {
            rw: v_i1_27825(1e3 * v_Ee_28084(v_e_32003.ou, v_s_32006.ou, v_a_32007)) / 1e3,
            aw: v_i1_27825(1e3 * v_Ee_28084(v_e_32003.ou + v_e_32003.Le, v_s_32006.ou + v_s_32006.Le, v_a_32007)) / 1e3,
            G0: v_Ee_28084(v_e_32003.G0, v_s_32006.G0, v_a_32007),
            cr: v_n_32004
          });
          break;
        }
      ...
      var v_e_32012 = v_pe_27823(v_t_32011, this.od);
      let v_n_32013 = 16,
        v_r_32014 = 0,
        v_s_32015 = v_u_31998;
      var v_a_32016,
      ...
      for (let v_t_32020 = 0; v_t_32020 < v_o_32017.length; ++v_t_32020) if ((v_a_32016 = v_o_32017[v_t_32020]).Fi !== v_c0_27703) {
        if (!v_l_32018 && v_a_32016.od >= v_e_32012 && (v_c_32019 = v_me_27822(v_pe_27823((v_e_32012 - v_s_32015.od) / (v_a_32016.od - v_s_32015.od), 0), 1), v_n_32013 = v_Ee_28084(v_s_32015.ou, v_a_32016.ou, v_c_32019), v_r_32014 = v_Ee_28084(v_s_32015.ou + v_s_32015.Le, v_a_32016.ou + v_a_32016.Le, v_c_32019), v_l_32018 = !0), v_l_32018) {
          if (v_a_32016.od >= v_i_32010) {
            var v_c_32019 = v_me_27822(v_pe_27823((v_i_32010 - v_s_32015.od) / (v_a_32016.od - v_s_32015.od), 0), 1);
            v_n_32013 = v_me_27822(v_n_32013, v_Ee_28084(v_s_32015.ou, v_a_32016.ou, v_c_32019)), v_r_32014 = v_pe_27823(v_r_32014, v_Ee_28084(v_s_32015.ou + v_s_32015.Le, v_a_32016.ou + v_a_32016.Le, v_c_32019));
            break;
          }
          v_n_32013 = v_me_27822(v_n_32013, v_a_32016.ou), v_r_32014 = v_pe_27823(v_r_32014, v_a_32016.ou + v_a_32016.Le);
        }
        v_s_32015 = v_a_32016;
      }
      v_n_32013 = v_i1_27825(v_n_32013), v_r_32014 = v_i1_27825(v_r_32014);
