  ...
  const v_Ae_27892 = function () {
    ...
    inputModule = function () {
      ...
      return {
        ...
        oe: function () {
          ...
          if ((useDirectInput ? di8KbdUpdateFn : kbdUpdateFn)(), inputEnabled) if (useDirectInput) for (let idx_5 = 0; idx_5 < keyBindings.length; ++idx_5) keyBindings[idx_5].lu |= di8KbdHeldFn(keyBindings[idx_5].sI) ? 2 : 0;else for (let idx_6 = 0; idx_6 < keyBindings.length; ++idx_6) keyBindings[idx_6].lu |= kbdHeldFn(keyBindings[idx_6].rI) ? 2 : 0;
          if (boardLanes && boardAir) {
            ...
            if (inputEnabled) if (useDirectInput) {
              for (let idx_11 = 0; idx_11 < laneState.length; ++idx_11) laneState[idx_11] |= di8KbdHeldFn(keyCodes[laneKeyChars[idx_11]]) || window.__umgLanes && window.__umgLanes[idx_11] ? 2 : 0;
              for (let idx_12 = 0; idx_12 < keyBindings.length; ++idx_12) keyBindings[idx_12].lu |= di8KbdHeldFn(keyBindings[idx_12].sI) ? 2 : 0;
            } else {
              for (let idx_13 = 0; idx_13 < laneState.length; ++idx_13) laneState[idx_13] |= kbdHeldFn(laneVk[idx_13]) || window.__umgLanes && window.__umgLanes[idx_13] ? 2 : 0;
              for (let idx_14 = 0; idx_14 < keyBindings.length; ++idx_14) keyBindings[idx_14].lu |= kbdHeldFn(keyBindings[idx_14].rI) ? 2 : 0;
            }
    ...
    v_G1_27905 = function () {
      ...
      async function v_i_28806() {
        if (1 <= handshake.On.Kp || (await new Promise(async v_i_28812 => {
          ...
          let v_e_28813 = doc.createElement("iframe");
    ...
    audioFontHub = function () {
      ...
      let v_c_29225 = void 0,
        ...
        v_n_29227 = doc.createElement("input");
