...
// 说明: 本文件是 bundle 片段, 由 build/assemble-game.mjs 按 manifest 拼接;请勿手改拼接顺序。
  ...
  v_Ss_28000.prototype = {
    ...
    T7: function (v_i_33619, v_e_33620) {
      for (let v_t_33621 = 0; v_t_33621 < 16; ++v_t_33621) void 0 === v_i_33619[15 - v_t_33621] ? (this.e9[3 + 2 * v_t_33621 * 3] = 0, this.e9[3 + 2 * v_t_33621 * 3 + 1] = 0, this.e9[3 + 2 * v_t_33621 * 3 + 2] = 0) : (this.e9[3 + 2 * v_t_33621 * 3] = mathRound(v_i_33619[15 - v_t_33621][2] / 255 * 254), this.e9[3 + 2 * v_t_33621 * 3 + 1] = mathRound(v_i_33619[15 - v_t_33621][0] / 255 * 254), this.e9[3 + 2 * v_t_33621 * 3 + 2] = mathRound(v_i_33619[15 - v_t_33621][1] / 255 * 254));
      for (let v_t_33622 = 0; v_t_33622 < 15; ++v_t_33622) void 0 === v_e_33620[14 - v_t_33622] ? (this.e9[3 + 3 * (2 * v_t_33622 + 1)] = 0, this.e9[3 + 3 * (2 * v_t_33622 + 1) + 1] = 0, this.e9[3 + 3 * (2 * v_t_33622 + 1) + 2] = 0) : (this.e9[3 + 3 * (2 * v_t_33622 + 1)] = mathRound(v_e_33620[14 - v_t_33622][2] / 255 * 254), this.e9[3 + 3 * (2 * v_t_33622 + 1) + 1] = mathRound(v_e_33620[14 - v_t_33622][0] / 255 * 254), this.e9[3 + 3 * (2 * v_t_33622 + 1) + 2] = mathRound(v_e_33620[14 - v_t_33622][1] / 255 * 254));
    }
  };