...
// 说明: 本文件是 bundle 片段, 由 build/assemble-game.mjs 按 manifest 拼接;请勿手改拼接顺序。
  ...
  v_As_28001.prototype = {
    ...
    d9: function (v_i_33631) {
      for (let v_t_33632 = 0; v_t_33632 < 6; ++v_t_33632) void 0 === v_i_33631[v_t_33632] ? (this.f9[3 + 3 * v_t_33632] = 0, this.f9[3 + 3 * v_t_33632 + 1] = 0, this.f9[3 + 3 * v_t_33632 + 2] = 0) : (this.f9[3 + 3 * v_t_33632] = v_i1_27825(v_i_33631[v_t_33632][2] / 255 * 254), this.f9[3 + 3 * v_t_33632 + 1] = v_i1_27825(v_i_33631[v_t_33632][0] / 255 * 254), this.f9[3 + 3 * v_t_33632 + 2] = v_i1_27825(v_i_33631[v_t_33632][1] / 255 * 254));
    }
